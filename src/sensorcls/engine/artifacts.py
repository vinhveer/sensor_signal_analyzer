"""Run output management: run info assembly and artifact saving."""
...
def build_run_info(history: dict, payload: dict, meta: dict, ctx: RunContext) -> dict:
    return {
...
def save_run_artifacts(history: dict, run_info: dict, scores: dict, test_true, test_pred, ctx: RunContext) -> None:
